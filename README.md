...
aplicação manual. Ver a tabela completa, os cuidados (secrets que não estão no git, Redirect
URI do Entra ID) e o passo a passo pra importar um cluster novo no README do diretório.
