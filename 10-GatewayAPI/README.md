...
```bash
oc apply -f 10-GatewayAPI/manifests/01-gatewayclass.yaml
...
```bash
oc apply -f 10-GatewayAPI/manifests/02-namespace.yaml
oc apply -f 10-GatewayAPI/manifests/03-app-a.yaml
oc apply -f 10-GatewayAPI/manifests/04-app-b.yaml
...
```bash
oc apply -f 10-GatewayAPI/manifests/05-gateway-a.yaml
oc apply -f 10-GatewayAPI/manifests/06-gateway-b.yaml
```
...
```bash
oc apply -f 10-GatewayAPI/manifests/07-httproute-a.yaml
oc apply -f 10-GatewayAPI/manifests/08-httproute-b.yaml
```
...
```bash
oc delete -f 10-GatewayAPI/manifests/08-httproute-b.yaml
oc delete -f 10-GatewayAPI/manifests/07-httproute-a.yaml
oc delete -f 10-GatewayAPI/manifests/06-gateway-b.yaml
oc delete -f 10-GatewayAPI/manifests/05-gateway-a.yaml
oc delete -f 10-GatewayAPI/manifests/04-app-b.yaml
oc delete -f 10-GatewayAPI/manifests/03-app-a.yaml
